<template>
  <div class="app-container">
    ...
    <el-table v-loading="loading" :data="studentList" @selection-change="handleSelectionChange">
      ...
      <el-table-column label="学生ID"  width="200" align="center" prop="stuId" />
      <el-table-column label="姓名" align="center" prop="stuName" />
      <el-table-column label="身份证号"  width="200" align="center" prop="sfzId" />
      ...
      <el-table-column label="社会面貌" align="center" prop="zhuzi">
        <template slot-scope="scope">
          <dict-tag :options="dict.type.society" :value="scope.row.zhuzi"/>
        </template>
      </el-table-column>
      <el-table-column label="家庭住址" align="center" prop="address" />
      <el-table-column label="电话号码"  width="200" align="center" prop="phone" />
      ...
      <el-table-column label="年级" align="center" prop="stuNianji">
        <template slot-scope="scope">
          <dict-tag :options="dict.type.stu_nianji" :value="scope.row.stuNianji"/>
        </template>
      </el-table-column>
      <el-table-column label="班主任" align="center" prop="stuBzr" />
    ...
    <el-dialog :title="title" :visible.sync="open" width="500px" append-to-body>
      <el-form ref="form" :model="form" :rules="rules" label-width="80px">
        ...
        <el-form-item label="身份证号" prop="sfzId">
          <el-input v-model="form.sfzId" placeholder="请输入身份证号" />
        </el-form-item>
        ...
        <el-form-item label="社会面貌" prop="zhuzi">
          <el-select v-model="form.zhuzi" placeholder="请选择社会面貌">
            <el-option
        ...
        <el-form-item label="年级" prop="stuNianji">
          <el-select v-model="form.stuNianji" placeholder="请选择年级">
            <el-option
        ...
        <el-form-item label="班主任" prop="stuBzr">
          <el-input v-model="form.stuBzr" placeholder="请输入班主任" />
        </el-form-item>
      </el-form>
...
export default {
  name: "Student",
  dicts: ['stu_nianji', 'stu_class', 'society', 'sys_user_sex'],
  data() {
    return {
      // 遮罩层
      loading: true,
