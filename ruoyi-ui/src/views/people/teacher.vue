<template>
  <div class="app-container">
    <el-form :model="queryParams" ref="queryForm" size="small" :inline="true" v-show="showSearch" label-width="68px">
      ...
      <el-form-item label="工号" prop="teaGh">
        <el-input
          v-model="queryParams.teaGh"
          placeholder="请输入工号"
          clearable
          @keyup.enter.native="handleQuery"
        />
    ...
    <el-table v-loading="loading" :data="teacherList" @selection-change="handleSelectionChange">
      ...
      <el-table-column label="工号" align="center" prop="teaGh" />
      ...
      <el-table-column label="民族" align="center" prop="mingzhu" />
      <el-table-column label="爱好" align="center" prop="hobby" />
      <el-table-column label="任课类型" align="center" prop="type">
        <template slot-scope="scope">
          <dict-tag :options="dict.type.stu_class" :value="scope.row.type"/>
        </template>
      </el-table-column>
    ...
    <el-dialog :title="title" :visible.sync="open" width="500px" append-to-body>
      <el-form ref="form" :model="form" :rules="rules" label-width="80px">
        ...
        <el-form-item label="工号" prop="teaGh">
          <el-input v-model="form.teaGh" placeholder="请输入工号" />
        </el-form-item>
        ...
        <el-form-item label="民族" prop="mingzhu">
          <el-input v-model="form.mingzhu" placeholder="请输入民族" />
        </el-form-item>
        <el-form-item label="爱好" prop="hobby">
          <el-input v-model="form.hobby" placeholder="请输入爱好" />
        </el-form-item>
        <el-form-item label="任课类型" prop="type">
          <el-select v-model="form.type" placeholder="请选择任课类型">
            <el-option
